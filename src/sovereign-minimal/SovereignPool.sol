...
import { Constants } from "@valantislabs/contracts/utils/Constants.sol";
import { ReentrancyGuard } from "@valantislabs/contracts/utils/ReentrancyGuard.sol";
import { ISwapFeeModule, SwapFeeModuleData } from "@valantislabs/contracts/swap-fee-modules/interfaces/ISwapFeeModule.sol";
...
import { IVerifierModule } from "@valantislabs/contracts/pools/interfaces/IVerifierModule.sol";
...
import { ISovereignOracle } from "@valantislabs/contracts/oracles/interfaces/ISovereignOracle.sol";
import { SovereignPoolConstructorArgs, SwapCache, SovereignPoolSwapParams } from "@valantislabs/contracts/pools/structs/SovereignPoolStructs.sol";
import { IFlashBorrower } from "@valantislabs/contracts/pools/interfaces/IFlashBorrower.sol";
...
contract SovereignPool is ISovereignPool, ReentrancyGuard {
    ...
    function withdrawLiquidity(
        ...
        emit WithdrawLiquidity(_recipient, _amount0, _amount1); ///  emit WithdrawLiquidity(_amount0, _amount1, _recipient) ????
    }
